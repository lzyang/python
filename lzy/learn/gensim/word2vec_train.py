...
if __name__ == '__main__':
    ...
    inp = "/Users/morningsun/data/word2vec/in_the_name_of_people_segment.txt"
    outp2 = "/Users/morningsun/data/word2vec/in_the_name_of_people.bin"

    # model = Word2Vec(LineSentence(inp), size=100, window=10, min_count=3,
    #         workers=multiprocessing.cpu_count(), sg=1, iter=10, negative=20)

    model = Word2Vec(LineSentence(inp), size=100, window=3, min_count=1,
